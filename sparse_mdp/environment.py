...
class NoisyGridworld(Gridworld):
	 ...
	 def __init__(self, shape, initial_state = None, can_stay=True, blocked=None, noise=0.1, TransitionClass=SparseTransition):
			"""
			Create a gridworld with the given size.  States are defined as (x,y)
			values, actions are in the set ['up','down','left','right','stay']
...
class Taskworld(DiscreteEnvironment):
	 ...
	 def __init__(self, shape, taskLocations, initial_state = None, can_stay=True, blocked=None, TransitionClass=SparseTransition):
			"""
